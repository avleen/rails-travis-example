[![Build Status](https://travis-ci.org/avleen/rails-travis-example.svg)](https://travis-ci.org/avleen/rails-travis-example) [![Code Climate](https://codeclimate.com/github/secure-pipeline/rails-travis-example.png)](https://codeclimate.com/github/secure-pipeline/rails-travis-example)
